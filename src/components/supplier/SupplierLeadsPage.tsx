        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 relative z-10">
          <div className="space-y-2 max-w-3xl">
            <div className="flex items-center space-x-2 text-xs font-semibold text-indigo-300 uppercase tracking-wider mb-1">
              ...
              <span className="text-indigo-400 font-bold">My Leads (Cơ Hội Vận Tải)</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-white flex items-center gap-3">
              ...
              <span>Cơ Hội Vận Tải Của Tôi (My Leads)</span>
            </h1>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5 mt-6 pt-6 border-t border-white/10 relative z-10">
          ...
          >
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-slate-300">Đang Mở (Open)</span>
            ...
            <div className="mt-2 flex items-baseline gap-1.5">
              <span className="text-2xl font-black text-blue-400 tracking-tight">{openCount}</span>
              <span className="text-xs font-bold text-blue-300/90">leads</span>
            </div>
            <p className="mt-1 text-[11px] text-slate-400 font-medium">Sẵn sàng nộp báo giá ngay</p>
          </div>
          ...
          >
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-slate-300">Đã Báo Giá (Quoted)</span>
            ...
            <div className="mt-2 flex items-baseline gap-1.5">
              ...
              <span className="text-xs font-bold text-purple-200/90">leads</span>
            </div>
            <p className="mt-1 text-[11px] text-slate-400 font-medium">Đang chờ chủ hàng xét duyệt</p>
          </div>
          ...
          >
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-slate-300">Thắng Thầu (Won)</span>
            ...
            <div className="mt-2 flex items-baseline gap-1.5">
              <span className="text-2xl font-black text-emerald-400 tracking-tight">{wonCount}</span>
              <span className="text-xs font-bold text-emerald-300/90">leads</span>
            </div>
            <p className="mt-1 text-[11px] text-slate-400 font-medium">Trúng thầu vận chuyển thành công</p>
          </div>
          ...
          >
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-slate-300">Trượt Thầu (Lost)</span>
              <div className="w-7 h-7 rounded-xl bg-rose-500/15 border border-rose-500/30 flex items-center justify-center text-rose-400 group-hover:scale-110 transition-transform">
                <XCircle className="w-3.5 h-3.5" />
              </div>
            </div>
            <div className="mt-2 flex items-baseline gap-1.5">
              <span className="text-2xl font-black text-rose-400 tracking-tight">{lostCount}</span>
              <span className="text-xs font-bold text-rose-300/90">leads</span>
            </div>
            <p className="mt-1 text-[11px] text-slate-400 font-medium">Chủ hàng đã chọn đối tác khác</p>
          </div>
        </div>
      </div>
