...
export const AirCargoCostMatrixModal: React.FC<AirCargoCostMatrixModalProps> = ({
  ...
  // TỔNG SỐ CỘT DỮ LIỆU (1 cột ĐVT riêng + các cột CBM + Min Charge CBM + các cột Kg)
  const totalDataCols = 1 + volumeTiers.length + 1 + weightTiers.length;
      ...
      <div className="w-full max-w-[96vw] 2xl:max-w-[1560px] h-[94vh] max-h-[95vh] bg-white rounded-2xl shadow-2xl border border-slate-200/80 overflow-hidden flex flex-col my-auto animate-in zoom-in-95 duration-150">
        ...
        <div className="px-5 py-3 bg-gradient-to-r from-slate-900 via-sky-950 to-indigo-950 text-white flex items-center justify-between border-b border-slate-800 shadow-md shrink-0 select-none">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-bold text-white flex items-center gap-2">
                <span>Biểu Phí Vận Tải Hàng Không (Air Cargo)</span>
              </h3>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <Plus className="w-3.5 h-3.5" />
              <span>+ Thêm Bậc Trọng Lượng (Kg)</span>
            </button>
        ...
        <div className="px-5 py-2 bg-slate-50 border-b border-slate-200 flex flex-wrap items-center justify-between gap-3 text-xs shrink-0 select-none">
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-slate-800 font-semibold">{route.origin} (Sân bay đi) ➔ {route.destination} (Sân bay đến)</span>
            </div>
          </div>
        </div>
          ...
          <table ref={tableRef} className="w-full border-collapse text-xs text-left min-w-[1380px]">
            <thead>
              ...
              <tr className="border-b border-slate-300 text-center font-bold">
                <th rowSpan={2} className="sticky left-0 z-30 bg-slate-100 text-slate-800 px-4 py-3 border-r-2 border-slate-300 text-xs w-[320px] min-w-[320px] shadow-[2px_0_5px_rgba(0,0,0,0.06)]">
                  DÒNG BIỂU PHÍ & DỊCH VỤ HÀNG KHÔNG
                </th>

                {/* CỘT ĐVT RIÊNG BIỆT */}
                <th rowSpan={2} className="bg-slate-100 text-slate-800 px-3 py-3 border-r-2 border-slate-300 text-xs text-center font-extrabold w-[100px] min-w-[100px]">
                  ĐVT
                </th>
            ...
            <tbody className="divide-y divide-slate-200">
              ...
              <tr className="bg-amber-50/90 font-bold divide-x divide-amber-200/80 border-b-2 border-amber-300">
                ...
                {/* ĐVT All-in */}
                <td className="border-r border-slate-200 px-2 py-2 text-center text-amber-900 font-bold bg-amber-50/90 text-[11px]">
              ...
              <tr className="bg-white hover:bg-slate-50/80 divide-x divide-slate-200 font-semibold">
                ...
                {/* ĐVT Cước Cơ Bản */}
                <td className="border-r border-slate-200 px-2 py-2 text-center text-slate-600 font-semibold bg-slate-50/50 text-[11px]">
                  {currency === 'USD' ? 'USD/Kg, CBM' : 'đ/Kg, CBM'}
                </td>
              ...
              {activeSurcharges.filter(s => s.type === 'fixed').map((surcharge) => {
                ...
                return (
                  <tr key={surcharge.id} className="hover:bg-slate-50/80 divide-x divide-slate-200">
                    ...
                    {/* Span across all remaining tier columns */}
                    <td colSpan={totalDataCols - 1} className="p-2 bg-emerald-50/20">
              ...
              {vasItems.map((vas) => {
                ...
                return (
                  <tr key={vas.id} className="hover:bg-slate-50/80 divide-x divide-slate-200">
                    ...
                    <td colSpan={totalDataCols - 1} className="p-2 bg-purple-50/20">
                      <div className="flex items-center justify-center gap-3">
                        <div className="flex items-center gap-1.5">
                          <input
                            type="number"
        ...
        <div className="px-5 py-3 bg-white border-t border-slate-200 flex items-center justify-end gap-2 shrink-0 shadow-lg select-none">
          ...
          >
            ...
            <span>Lưu Biểu Phí Air Cargo</span>
          </button>
        </div>
      </div>
