...
export const RailFclCostMatrixModal: React.FC<RailFclCostMatrixModalProps> = ({
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-[140] flex items-center justify-center p-2.5 sm:p-4 bg-slate-950/75 backdrop-blur-xs overflow-hidden animate-in fade-in duration-150"
    >
